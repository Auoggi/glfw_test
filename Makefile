...
WIN_LIBS := ./include/GLFW/lib-mingw-w64/libglfw3.a -lopengl32 -lgdi32
...
# $(BUILD_DIR)/texture_gl.exe: $(BUILD_DIR) texture_gl.exe.o $(DEPS)
# 	x86_64-w64-mingw32-g++ $(CXXFLAGS) texture_gl.o $(DEPS) -o $@ $(WIN_LIBS)
